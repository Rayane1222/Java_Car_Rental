...
public class Form_Customers extends javax.swing.JFrame {
    ...
    public Form_Customers() {
        ...
        displayImage(jLabel9.getWidth(),jLabel9.getHeight(),getClass().getResource("images/customers.png").getFile(),jLabel9);
    }
    ...
    public boolean verify()
    {
                ...
                !birthdate.trim().equals(""))
        {
            ...
            JOptionPane.showMessageDialog(null , "Enter Valid Customer Data","Invalid Info",2);
                    val= false;
        }
        return val;
    }
...
//      jDateChooser_BirthDate.set(cst.getBirthdate());
    ...
    private void jButton_EditCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_EditCustomerActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null , "Add a Valid Date "+ex.getMessage()," Error",1);
        }
